            ...
            do
                ...
                do
                    ...
                    do
                        ...
                        file_key=${AGENT_CLASS}_${POLICY_CLASS}_actor${ACTOR_LR}_critic${CRITIC_LR}_niter${N_ITER}_reg${REG}_ep${INITEP}_noise${HA_VAR}_bs${BS}_epbs${EP_BS}_step${MAX_STEP}_seed${SEED}_slatesize${SLATE_SIZE}
