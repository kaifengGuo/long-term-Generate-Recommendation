        ...
        do
            ...
            do
                ...
                do
                    ...
                    do
                        mkdir -p ${output_path}agents/A2C_${POLICY_CLASS}_actor${ACTOR_LR}_critic${CRITIC_LR}_niter${N_ITER}_reg${REG}_ep${INITEP}_noise${HA_VAR}_bs${BS}_epbs${EP_BS}_step${MAX_STEP}_seed${SEED}_slatesize${SLATE_SIZE}/
                        ...
                        python train_actor_critic.py\
                            ...
                            --check_episode 10\
                            --save_episode 200\
                            --save_path ${output_path}agents/A2C_${POLICY_CLASS}_actor${ACTOR_LR}_critic${CRITIC_LR}_niter${N_ITER}_reg${REG}_ep${INITEP}_noise${HA_VAR}_bs${BS}_epbs${EP_BS}_step${MAX_STEP}_seed${SEED}_slatesize${SLATE_SIZE}/model\
                            --actor_lr ${ACTOR_LR}\
                            --actor_decay ${REG}\
                            --batch_size ${BS}\
                            --critic_lr ${CRITIC_LR}\
                            ...
                            > ${output_path}agents/A2C_${POLICY_CLASS}_actor${ACTOR_LR}_critic${CRITIC_LR}_niter${N_ITER}_reg${REG}_ep${INITEP}_noise${HA_VAR}_bs${BS}_epbs${EP_BS}_step${MAX_STEP}_seed${SEED}_slatesize${SLATE_SIZE}/log
                    done
                done
            done
        done
